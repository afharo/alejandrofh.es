(function () {
  ...
  $(document).ready(function() {
    ...
    $(".fp-controlArrow.fp-next").html('<ng-md-icon icon="keyboard_arrow_right"></ng-md-icon>');
    $(".fp-controlArrow.fp-next").attr('style','top: 70%;right: 25px;border: none;');
    $(".fp-controlArrow.fp-prev").html('<ng-md-icon icon="keyboard_arrow_left"></ng-md-icon>');
